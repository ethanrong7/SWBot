...
public class RuneAuto {
    ...
    public void evaluate() throws Exception {
        ...
        // determine rune type //
        for (int i = 0; i < 16; i++) {
            String runeTypeArray[] = {"nemesis", "destroy", "will", "vampire", "rage",
                                      "violent", "focus", "guard", "endure", "shield", "revenge",
                                      "despair", "energy", "fatal", "blade", "swift"};
            if (ImageToText.convert2("temporary images", "rune_heading").
                    toLowerCase().contains(runeTypeArray[i])) {
                System.out.println("Rune type: " + runeTypeArray[i]);
            }                   
        }
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (ImageToText.ImageCompare2("fixed auto images","rune_grade_" + grade[i],"temporary images", "rune_grade") == 100) {
        ...
        // determine main stat //
        String mainstat = ImageToText.convert2("temporary images", "rune_MainStat");
        ...
        String slot = ImageToText.convert2("temporary images","rune_heading"); 
        ...
        // determine substats // 
        String[] array = ImageToText.convert2("temporary images","rune_substat").split("\\n"); 
    ...
    public void RuneGrade() throws Exception {
       Robot robot = null;      
       try {
           robot = new Robot();
       ...
       screenshot = robot.createScreenCapture(new Rectangle(1112, 318, 167, 37));
       File output2 = new File("C:\\Users\\Owner\\Documents\\NetBeansProjects\\SWBot_v1.00 copy\\temporary images\\rune_grade.tiff");
       try {
         ImageIO.write(screenshot, "tiff", output2);
       } catch (IOException e) {
           e.printStackTrace();
       }
    }
    
    public void RuneHeading() throws Exception {
       Robot robot = null;      
       try {
           robot = new Robot();
       } catch (AWTException e) {
       ...
       BufferedImage screenshot = null;       
       screenshot = robot.createScreenCapture(new Rectangle(622, 225, 611, 60));
       File output2 = new File("C:\\Users\\Owner\\Documents\\NetBeansProjects\\SWBot_v1.00 copy\\temporary images\\rune_heading.tiff");
       try {
         ImageIO.write(screenshot, "tiff", output2);
       } catch (IOException e) {
           e.printStackTrace();
       }
       // need to grey it out for image to text conversion // 
       Opencv.GreyScale2("temporary images", "rune_heading");
    }
    
    public void RuneMainStat() throws Exception {
       Robot robot = null;      
       try {
           robot = new Robot();
       } catch (AWTException e) {
       ...
       BufferedImage screenshot = null;       
       screenshot = robot.createScreenCapture(new Rectangle(732, 305, 338, 50));
       ...
       // need to grey it out for image to text conversion // 
       Opencv.GreyScale2("temporary images", "rune_MainStat");
    }
    
    public void RuneSubStat() throws Exception {
       Robot robot = null;      
       try {
           robot = new Robot();
       } catch (AWTException e) {
       ...
       BufferedImage screenshot = null;       
       screenshot = robot.createScreenCapture(new Rectangle(586, 432, 273, 178));
       ...
       // need to grey it out for image to text conversion // 
       Opencv.GreyScale2("temporary images", "rune_Substat");
    }
}
